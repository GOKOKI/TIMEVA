        ...
        <div class="lg:col-span-1">
            <nav class="bg-gray-50 rounded-lg overflow-hidden">
                <a href="{{ route('profile.index') }}" 
                   class="flex items-center gap-3 px-6 py-4 {{ request()->routeIs('profile.index') ? 'bg-gray-100 border-l-4 border-black font-medium' : 'hover:bg-gray-100' }} transition-colors">
