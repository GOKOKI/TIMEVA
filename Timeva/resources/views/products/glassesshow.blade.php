...
<div class="container mx-auto px-4 py-8">
    <!-- Bouton Retour -->
    <a href="{{ route('products.glasses') }}" class="inline-flex items-center gap-2 text-gray-700 hover:text-black mb-8">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-12">
        ...
        <div class="bg-gray-200 rounded-2xl overflow-hidden aspect-square flex items-center justify-center p-12">
            <img src="{{ asset('images/glasses1.jpg') }}" alt="Glasses" class="w-full h-full object-contain">
        </div>

        <!-- Détails du produit -->
        <div class="flex flex-col">
            <p class="text-xs text-gray-500 uppercase tracking-widest mb-3">TIMEVA GLASSES</p>
            <h1 class="text-4xl lg:text-5xl font-bold mb-6">Carree Minialiste</h1>
            <p class="text-3xl font-bold mb-6">120.00 €</p>
            
            <p class="text-gray-600 mb-8 leading-relaxed">
                Lunettes aviateur intemporelles avec monture en titane et verres polarisés anti-reflets
            </p>
            ...
            <div class="mb-8">
                ...
                <div class="flex gap-3">
                    ...
                    <button class="w-12 h-12 rounded-full bg-amber-700 border-2 border-gray-300 hover:border-gray-500 transition-colors focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-amber-700"></button>
                    <button class="w-12 h-12 rounded-full bg-gray-400 border-2 border-gray-300 hover:border-gray-500 transition-colors focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500"></button>
                </div>
            </div>
            ...
            <!-- Stock -->
            <p class="text-sm text-gray-700 mb-6">15 en stock</p>
